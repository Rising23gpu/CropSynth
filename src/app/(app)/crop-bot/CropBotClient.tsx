...
export default function CropBotClient() {
  ...
  if (farms.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600 mb-6">You need to create a farm first to use the crop bot.</p>
        <a
          href="/farm/create"
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="space-y-6">
        ...
        {/* ChatBot Component */}
        {selectedFarmId && <ChatBot farmId={selectedFarmId} />}
      </div>
    </div>
  );
}